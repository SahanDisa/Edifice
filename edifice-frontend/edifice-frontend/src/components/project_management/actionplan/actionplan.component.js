    ...
    render() {
        return (
            <div className="">
                ...
                <h4>All the action plans</h4><hr/>
                <ul className="list-group">
                    <li className="list-group-item ">
                        <a href="/manageactionplan/view" style={{ 'text-decoration': 'none'}}>1 - Replace the Broken Switch Plate</a>
                    </li>
                    <li className="list-group-item ">
                ...
                <a href="/manageactionplan/create" className="btn btn-primary mt-2">+ Add Another Action Plan Item</a>
            </div>
        );
    }
